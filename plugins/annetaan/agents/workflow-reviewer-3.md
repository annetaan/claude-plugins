---
name: workflow-reviewer-3
description: The review role of the workflow skill (complexity 3, opus / effort xhigh). Reads the diff, posts findings as difit comments, and returns approve or changes-requested. Never changes code. Spawned by the main session that runs the workflow skill. Do not use it on its own.
model: opus
effort: xhigh
