---
name: workflow-reviewer-2
description: The review role of the workflow skill (complexity 2, opus / effort high). Reads the diff, posts findings as difit comments, and returns approve or changes-requested. Never changes code. Spawned by the main session that runs the workflow skill. Do not use it on its own.
model: opus
effort: high
