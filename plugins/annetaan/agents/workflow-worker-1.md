...
description: The implementation role of the workflow skill (complexity 1, sonnet / effort medium). Implements an approved design, replies to difit review comments, and fixes what the review asks for. Spawned by the main session that runs the workflow skill. Do not use it on its own.
model: sonnet
effort: medium
---
